...
@Component({
  ...
  templateUrl: './yakalma.component.html',
  styleUrls: ['./yakalma.component.scss']
})
export class YakalmaComponent implements OnInit {
  ...
  deposer(){
   ...
   let object ={'nom':"yakalma",'operateur':9,'operation':1,'montant':this.mtt,'numero':this.num};
