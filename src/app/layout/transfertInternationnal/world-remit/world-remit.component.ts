...
export class WorldRemitComponent implements OnInit {
  ...
  retirer(){
    ...
    let object ={'nom':'World-Remit retrait','operateur':11,'operation':1,'nom_benef':this.data.nom_benef,'prenom_benef':this.data.prenom_benef,
  ...
  envoyer(){
    ...
    for(let i of this.listPays){
     ...
     let object ={'nom':'World-Remit envoie','operateur':11,'operation':2,'info':this.envoie};
     console.log(JSON.stringify(object));
